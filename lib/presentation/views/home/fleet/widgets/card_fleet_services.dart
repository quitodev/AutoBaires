...
class CardFleetServices extends StatefulWidget {
  const CardFleetServices({
    Key? key,
  ...
  final FleetServices service;
  final int carKilometres;
  final Color background;
  final IconData icon;

  @override
  State<CardFleetServices> createState() => _CardFleetServicesState();
}

class _CardFleetServicesState extends State<CardFleetServices> {
  @override
