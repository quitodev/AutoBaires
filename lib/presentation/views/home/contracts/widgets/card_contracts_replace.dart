...
class CardContractsReplace extends StatefulWidget {
  const CardContractsReplace({
    Key? key,
    required this.car,
  }) : super(key: key);

  final ContractsFleet car;

  @override
  State<CardContractsReplace> createState() => _CardContractsReplaceState();
}

class _CardContractsReplaceState extends State<CardContractsReplace> {
  @override
  Widget build(BuildContext context) {
    return Container(
      height: HEIGHT_CARD_DETAIL_REPLACE,
